 ...
 * an explicit admin check. Defaults to the `recruiting` schema — see client.ts.
 * Not used by the candidates page port; kept for the invite/delete-user
 * routes when those get ported.
 */
